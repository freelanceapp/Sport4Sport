package technology.infobite.com.boommenu2.boom_menu.BoomButtons;
...
import static technology.infobite.com.boommenu2.boom_menu.BoomButtons.ButtonPlaceEnum.Horizontal;
        ...
        switch (bmb.getButtonPlaceEnum()) {
            ...
            default:
                if (buttonNumber >= 2
                        ...
                        && !bmb.getButtonPlaceEnum().equals(Horizontal))
