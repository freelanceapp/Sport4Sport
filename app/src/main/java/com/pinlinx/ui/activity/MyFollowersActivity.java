...
public class MyFollowersActivity extends BaseActivity implements View.OnClickListener, SearchListAdapter.SearchAdapterListener {
    ...
    private void init() {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(MyFollowersActivity.this, 2);
    ...
    private void allUserListApi() {
        if (cd.isNetworkAvailable()) {
            RetrofitService.getAllUserData(new Dialog(mContext), retrofitApiClient.myFans(strUserId), new WebResponse() {
                @Override
